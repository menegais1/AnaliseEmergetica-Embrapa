        ...
        <form action="lv2p2.jsp" method="post">
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <input type="number" class="form-control" value="<%=passos.getLv2p2().getNovilhos13a24Janmar()%>" placeholder="Insira a quantidade de novilhos: 13 a 24 Meses de janeiro a março" name="novilhos_13a24_janmar" max="1000000" min="0" required>
                    <label>Novilhos: 13 a 24 Meses de Abril a Junho</label>
                    <input type="number" class="form-control" value="<%=passos.getLv2p2().getNovilhos13a24Abrjun()%>" placeholder="Insira a quantidade de novilhos: 13 a 24 Meses de abril a junho" name="novilhos_13a24_abrjun" max="1000000" min="0" required>
                    <label>Novilhos: 13 a 24 Meses de Julho a Setembro</label>
                    <input type="number" class="form-control" value="<%=passos.getLv2p2().getNovilhos13a24Julset()%>" placeholder="Insira a quantidade de novilhos: 13 a 24 Meses de julho a setembro" name="novilhos_13a24_julset" max="1000000" min="0" required>
                    <label>Novilhos: 13 a 24 Meses de Outubro a Dezembro</label>
                    <input type="number" class="form-control" value="<%=passos.getLv2p2().getNovilhos13a24Outdez()%>" placeholder="Insira a quantidade de novilhos: 13 a 24 Meses de outubro a dezembro" name="novilhos_13a24_outdez" max="1000000" min="0" required>

                    <h3>Novilhas: 13 a 24 Meses</h3>

                    <label>Novilhas: 13 a 24 Meses de Janeiro a Março</label>
                    <input type="number" class="form-control" value="<%=passos.getLv2p2().getNovilhas13a24Janmar()%>" placeholder="Insira a quantidade de novilhas: 13 a 24 Meses de janeiro a março" name="novilhas_13a24_janmar" max="1000000" min="0" required>
                    <label>Novilhas: 13 a 24 Meses de Abril a Junho</label>
                    <input type="number" class="form-control" value="<%=passos.getLv2p2().getNovilhas13a24Abrjun()%>" placeholder="Insira a quantidade de novilhas: 13 a 24 Meses de abril a junho" name="novilhas_13a24_abrjun" max="1000000" min="0" required>
                    <label>Novilhas: 13 a 24 Meses de Julho a Setembro</label>
                    <input type="number" class="form-control" value="<%=passos.getLv2p2().getNovilhas13a24Julset()%>" placeholder="Insira a quantidade de novilhas: 13 a 24 Meses de julho a setembro" name="novilhas_13a24_julset" max="1000000" min="0" required>
                    <label>Novilhas: 13 a 24 Meses de Outubro a Dezembro</label>
                    <input type="number" class="form-control" value="<%=passos.getLv2p2().getNovilhas13a24Outdez()%>" placeholder="Insira a quantidade de novilhas: 13 a 24 Meses de outubro a dezembro" name="novilhas_13a24_outdez" max="1000000" min="0" required>

                    <h3>Novilhos: 25 a 36 Meses</h3>

                    <label>Novilhos: 25 a 36 Meses de Janeiro a Março</label>
                    <input type="number" class="form-control" value="<%=passos.getLv2p2().getNovilhos25a36Janmar()%>" placeholder="Insira a quantidade de novilhos: 25 a 36 Meses de janeiro a março" name="novilhos_25a36_janmar" max="1000000" min="0" required>
                    <label>Novilhos: 25 a 36 Meses de Abril a Junho</label>
                    <input type="number" class="form-control" value="<%=passos.getLv2p2().getNovilhos25a36Abrjun()%>" placeholder="Insira a quantidade de novilhos: 25 a 36 Meses de abril a junho" name="novilhos_25a36_abrjun" max="1000000" min="0" required>
                    <label>Novilhos: 25 a 36 Meses de Julho a Setembro</label>
                    <input type="number" class="form-control" value="<%=passos.getLv2p2().getNovilhos25a36Julset()%>" placeholder="Insira a quantidade de novilhos: 25 a 36 Meses de julho a setembro" name="novilhos_25a36_julset" max="1000000" min="0" required>
                    <label>Novilhos: 25 a 36 Meses de Outubro a Dezembro</label>
                    <input type="number" class="form-control" value="<%=passos.getLv2p2().getNovilhos25a36Outdez()%>" placeholder="Insira a quantidade de novilhos: 25 a 36 Meses de outubro a dezembro" name="novilhos_25a36_outdez" max="1000000" min="0" required>

                    <h3>Novilhas: 25 a 36 Meses</h3>

                    <label>Novilhas: 25 a 36 Meses de Janeiro a Março</label>
                    <input type="number" class="form-control" value="<%=passos.getLv2p2().getNovilhas25a36Janmar()%>" placeholder="Insira a quantidade de novilhas: 25 a 36 Meses de janeiro a março" name="novilhas_25a36_janmar" max="1000000" min="0" required>
                    <label>Novilhas: 25 a 36 Meses de Abril a Junho</label>
                    <input type="number" class="form-control"  value="<%=passos.getLv2p2().getNovilhas25a36Abrjun()%>" placeholder="Insira a quantidade de novilhas: 25 a 36 Meses de abril a junho" name="novilhas_25a36_abrjun" max="1000000" min="0" required>
                    <label>Novilhas: 25 a 36 Meses de Julho a Setembro</label>
                    <input type="number" class="form-control" value="<%=passos.getLv2p2().getNovilhas25a36Julset()%>" placeholder="Insira a quantidade de novilhas: 25 a 36 Meses de julho a setembro" name="novilhas_25a36_julset" max="1000000" min="0" required>
                    <label>Novilhas: 25 a 36 Meses de Outubro a Dezembro</label>
                    <input type="number" class="form-control" value="<%=passos.getLv2p2().getNovilhas25a36Outdez()%>" placeholder="Insira a quantidade de novilhas: 25 a 36 Meses de outubro a dezembro" name="novilhas_25a36_outdez" max="1000000" min="0" required>
